...
fun InstallmentCard(installment: InstallmentCardUIModel, onClick: () -> Unit) {
    ...
    //SEP 2025
    val selectedDay = transaction.transactionDate.toAppDate() // 12.09.2024
    val selectedLatPaymentDay = installment.card?.statementDay ?: 1 // 5
    ...
    Card(
        ...
        Row(
            ...
            Box(// OPSİYONEL GÖRSEL // todo sonra eklenebilir
                modifier = Modifier.size(48.dp).padding(end = 12.dp),
                contentAlignment = Alignment.Center
            ) {
                Text("📦") // şimdilik dummy icon
            }
            ...
            Column {
                ...
                Row {
                    ...
                    Column {
                        ...
                        Text(
                            text =UiText.StringResourceId(Res.string.installment_label,arrayOf( (transaction.installmentIndex?:0)+1, transaction.installmentCount?:1)).asString(),
                    ...
                    Column(horizontalAlignment = Alignment.End) {
                        ...
                        Text(
                            text = if (isPast) UiText.StringResourceId(Res.string.installment_paid).asString() else UiText.StringResourceId(Res.string.installment_pending).asString(),
                            style = AppTypography.bodySmall,
                            color = if (isPast) AppColors.primary
